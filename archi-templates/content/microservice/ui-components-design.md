...
本文档描述 {{serviceName}} 的UI组件设计，包括组件库、组件规范、主题管理等。

UI组件是表现层的基础，提供可复用的UI组件，提高开发效率和一致性。
...
- [[../02-product/ux-design.md]] - 用户体验设计（设计规范参考）
